...
const setUpDialogModal = (dialog) => {
    ...
    const focusableElements = Array.from(dialog.querySelectorAll("a, button, input, textarea, select, details, [tabindex]:not([tabindex='-1'])"));
